...
Namespace CustomDatesPivot
	Friend Class DateDataSourceWrapper
		...
		Public ReadOnly Property NestedTypedList() As ITypedList
			Get
				Return DirectCast(NestedList, ITypedList)
			End Get
		End Property
		Public Sub New(ByVal OriginalDatasource As ITypedList, ByVal dateFields As List(Of String), ByVal customDates As List(Of DateTime))
			...
			Me.NestedList = DirectCast(OriginalDatasource, IList)
			...
			Public Overrides Function GetValue(ByVal component As Object) As Object
				If TypeOf component Is DateTime Then
					If _DateFields.Contains(NestedDescriptor.Name) Then
						Return DirectCast(component, DateTime)
					End If
					Return Nothing
				Else
		...
		Public Function Contains(ByVal value As Object) As Boolean Implements IList.Contains
			If TypeOf value Is DateTime Then
				Return CustomDates.Contains(DirectCast(value, DateTime))
			End If
			Return NestedList.Contains(value)
		End Function
		Public Function IndexOf(ByVal value As Object) As Integer Implements IList.IndexOf
			If TypeOf value Is DateTime AndAlso CustomDates.Contains(DirectCast(value, DateTime)) Then
				Return CustomDates.IndexOf(DirectCast(value, DateTime))
			End If
